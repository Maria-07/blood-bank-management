...
const ContactPage = () => {
  const tabItems = [
    {
      label: (
        <h1 className="text-dark text-base hover:text-primary">Contact</h1>
      ),
      key: 1,
    ...
    {
      label: (
        <h1 className="text-dark text-base hover:text-primary">Suggestion</h1>
      ),
      key: 2,
    ...
    {
      label: (
        <h1 className="text-dark text-base hover:text-primary">Complain</h1>
      ),
      key: 3,
