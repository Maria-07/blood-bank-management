...
const Volunteer = ({ record }) => {
  return (
    <div className=" h-full">
      <Card
        hoverable
        className="bg-white border-0 shadow-xl rounded-2xl p-0 w-full max-w-xs h-[370px] flex flex-col justify-between transition-transform duration-200 hover:scale-105"
        bodyStyle={{ padding: 0, height: "100%" }}
      >
        {/* Profile Image with Gradient Ring */}
        <div className="flex flex-col items-center pt-8">
          <div className="relative">
            <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-primary to-secondary blur-sm"></div>
            <Image
