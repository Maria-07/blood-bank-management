...
import ApproveVolunteerModal from "../Volunteers/ApproveVolunteerModal";
import DisApproveVolunteerModal from "../Volunteers/DisApproveVolunteerModal";
import UserInfo from "@/src/Hook/UserInfo";

const AdminActionModal = ({ record }) => {
  //! User data
  const user = UserInfo();
